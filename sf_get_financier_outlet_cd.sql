create or replace function muldms.sf_get_financier_outlet_cd(p_mul_dealer_cd in varchar2,
                                        p_for_cd        in varchar2,
                                        p_outlet_cd     in varchar2)
  return varchar2 is
  lv_outlet_cd varchar2(10);
...
-------
  ...
  if lv_outlet_cd is null and lv_parent_group is not null then
    begin
      select ew.financier_outlet_cd
        into lv_outlet_cd
...
end sf_get_financier_outlet_cd;
